...
const POSTS: Post[] = [
  {
    ...
    img: "/assets/img1.png",
    href: "/blog/signs-home-nursing-care",
    cta: "Read Article",
  ...
  },
  {
    ...
    img: "/assets/img3.png",
    href: "/blog/longevity-medicine-2025",
    cta: "Read Article",
...
function HorizontalCard({ post }: { post: Post }) {
  return (
    <article className="flex flex-col overflow-hidden rounded-[24px] bg-white p-3 shadow-[0_12px_30px_-22px_rgba(20,10,16,0.5)] ring-1 ring-black/5 sm:flex-row">
      <div className="overflow-hidden rounded-[18px] sm:w-[42%] sm:shrink-0">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={post.img}
          alt={post.title}
          className="h-44 w-full object-cover sm:h-full sm:min-h-[240px]"
          loading="lazy"
        />
      </div>
